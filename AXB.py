...
for nt in range(20000):
    ...
    azan=f"Mozilla/5.0 (Linux; Android 10; Infinix X682B) AppleWebKit/{str(rr(1,9))}.{str(rr(1,9))}.{str(rr(999, 9999))}/{str(rr(100, 300))}.{str(rr(150, 300))}; U; en) Presto/{str(rr(1, 10))}.{str(rr(10, 20))}.{str(rr(300, 600))} Version/{str(rr(10, 20))}.{str(rr(10, 20))}"
    UserAgents.append(AXB)
loop = 0
cp = []
ok = []
twf = []
...
logo ="""  \033[1;92m###    ##     ## ######## 
  ...
  \033[1;97m
\033[1;97m====================================================
\033[1;97m[+]\033[1;91m    AUTHOR   \033[1;90m: \033[1;92mAzan Ali
\033[1;97m[+]\033[1;91m    FACEBOOK \033[1;90m: \033[1;92mAzan X.
\033[1;97m[+]\033[1;91m    WHATSAPP \033[1;90m: \033[1;92m+923165456679
\033[1;97m====================================================
