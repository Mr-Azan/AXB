...
# PROSES CRACK METODE 3 in 1
    ...
    def kombinasi_pw(self,url):
        ...
        print(' %s[%s1%s] name,nama123,nama12345'%(N,H,N))
        print(' %s[%s2%s] name,nama123,nama1234,nama12345'%(N,H,N))
        print(' %s[%s3%s] name,nama123,nama1234,nama12345,%s+Sandi%s'%(N,H,N,H,N))
