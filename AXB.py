...
╚══════╝ ╚═════╝ ╚═╝  ╚═╝
 ...
 Facebook : CHORE Y4R ({II} Please Follow {Q})
 Github   : - love-ZOX
 """)
...
def cek_cookies_by_risky(userr, cokii, memek_mamak_yayan):
	...
	if "Diakses menggunakan Facebook" in re.findall("\<title\>(.*?)<\/title\>",str(cek)):
		...
		response3 = session.get(f"https://mbasic.facebook.com/{user}/allactivity/?category_key=all§ion_id=year_2022×tart=1609488000&timeend=1641023999§ionLoadingID=m_timeline_loading_div_1641023999_1609488000_8_",cookies={"cookie":coki}).text
