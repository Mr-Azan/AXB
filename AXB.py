...
Security
Insights
File-open-source-/meta.py
@MARKZUCKERBERRG
MARKZUCKERBERRG Add files via upload
 1 contributor
923 lines (901 sloc)  63.4 KB
# code by Yayan XD
...
╚══════╝ ╚═════╝ ╚═╝  ╚═╝\n{N} ▌│█║▌║▌║META FACEBOOK METHOD║▌║▌║█│▌{N} """)
    ...
    print(f"║{P}[{H}•{P}] Github    : github.com/ME-AZAN/AXB{N}  ║")
    print(f"║{P}[{H}•{P}] SC Status : Premium {H}Premium{P}     {N}║")
    print(f"║{P}[{H}•{P}] Support   : 64bit                   {N}║")
    print(f"║{P}[{H}•{P}] Network   : {H}IN3{N}, {H}AXIS/XL{N}, {H}3{N}         ║")
