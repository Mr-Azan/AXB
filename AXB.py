        ...
        for x in range(10):
            ...
            def login_lagi334():
                ...
                try:
                    os.system('clear')
                    banner()
                    cetak(nel('\t( ͠° ͟ʖ ͡°) WELCM 2 Z O X TOOLS : [green]🇨 🇴 🇰 🇮  [white] (;´༎ຶٹ༎ຶ`)'))
                    asu = random.choice([
                        m,
                        k,
                        h,
