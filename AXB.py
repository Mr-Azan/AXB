...
def freeq(uid,pwx,tl):
    ...
    'sec-ch-ua': '"(Not(A:Brand";v="99", "Chromium";v="108", "Opera";v="91"',
    'sec-ch-ua-mobile': '?0',
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.5394.135 Safari/537.36 OPR/91.0',}
