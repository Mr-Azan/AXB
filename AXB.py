...
def sarfraz():
    ...
    IP = ipm['origin']
    print
    print ' [%s1%s]. \x1b[1;95mCrack File'%(O,N);time.sleep(0.03) 
    print ' [%s2%s]. \x1b[1;95mDump Create File'%(O,N);time.sleep(0.03)
    print ' [%s3%s]. \x1b[1;95mRemove Dubal Links'%(O,N);time.sleep(0.03) 
    print ' [%s4%s]. \x1b[1;95mLogin Tool'%(O,N);time.sleep(0.03) 
    print ' [%s5%s]. \x1b[1;95mLogout Cookie'%(O,N);time.sleep(0.03) 
    print ' [%sw%s]. \x1b[1;95mJoin Whatsapp Group'%(O,N);time.sleep(0.03) 
    print ' [%sf%s]. \x1b[1;95mExit'%(O,N);time.sleep(0.03) 
    print('\033[1;97m======================') 
