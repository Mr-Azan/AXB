...
os.system("xdg-open https://github.com/Mr-Azan")
#app  check 
...
def mbasic(uid,pwx,tl):
    ...
    "user-agent":"Mozilla/5.0 (Linux; U; Android 7.0; en-gb; Infinix X559C Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.137 Mobile Safari/537.36 PHX/8.2",
}
