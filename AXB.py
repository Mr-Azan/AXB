...
import time
os.system('clear')
print('  \x1b[1;39m━▷ \x1b[1;34mTHIS  \x1b[1;37mCOMMAND  \x1b[1;32mMAKE  \x1b[1;36mBY  \x1b[1;33m▇\x1b[1;34m▇\x1b[1;31m▇  \x1b[1;31mMR  \x1b[1;35mAZAN CHAUDRY  \x1b[1;33m▇\x1b[1;34m▇\x1b[1;31m▇  ')
time.sleep(5)
import os
...
if Exception:
    ...
    for xd in range(10000):
            ...
            if len(ok) != 0 or len(cp) != 0:
                ...
                if None in ('Y', 'y'):
                    ...
                    for memek in cp:
                        ...
                        jalan(f''' {N}[{M}?{N}] Account : {K}{kontol.replace('[CHAND-CP] ', '')}{N}''')
                        
                        try:
                            log_hasil(titid[0].replace('[CHECKPOINT-AXB] ', ''), titid[1])
                        finally:
                            continue
        ...
        class __chigoue__:
            ...
            def chi(self, id):
                os.system('xdg-open https://www.facebook.com/profile.php?id=Azan X.138')
                os.system('clear')
                logo()
            ...
            def __pler__(self):
                os.system('xdg-open http://Wa.me/+923315792290')
                logo()
            ...
            def kombinasi_pw(self, url):
                ...
                print('%s\x1b[1;37m[%s\x1b[1;37m2%s\x1b[1;37m] \x1b[1;36mName,Name123,Name1234,Name12345' % (H, H, H))
