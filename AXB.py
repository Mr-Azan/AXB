...
def logo():
    print("""\n
\033[97;1m(✓)═══════════════════════════════════════
\033[91;1m(!) OWNER   :  AZAN ALI
\033[92;1m(!) CONTACT : +9231654566679
\033[96;1m(!) Facebook :  AZAN ALU
\033[94;1m(!) Type     :  FREE
\033[95;1m(!) Enjoy CLONING TOOL 🥀
\033[97;1m(✓)═══════════════════════════════════════
\033[97;1m(✓)═══════════════════════════════════════
\033[92;1m    THIS TOOL CREATED BY AZAN ALI
\033[97;1m(✓)═══════════════════════════════════════""")
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            if ww in ("Y","y","ya"):
                ubahP.append("y")
                print(f" {N}[{H}•{N}] Password example : {H}AZAN123{N}")
...
def crackmbasic(idf,pwv):
    ...
    def kombinasi_pw(self,url):
        ...
        print('%s[%s1%s] first last,First Last,firstlast,first123,FirstLast,first1234,First1234,first12345,First12345,first786,First786,first12,First12'%(H,H,H))
        print('%s[%s2%s] Name,khan khan,khankhan,khan123,khan12345,khan786,786786,khan1122,janjan,ali1122,ali786,ali12345,aliali,alikhan'%(H,H,H))
