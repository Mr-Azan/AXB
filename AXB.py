...
def main_system():
    ...
    print(' [5]   Check Subscription ')
    print(' [6]   Update Tools ')
    print(' [7]   For Any Help Massage WhatsApp ')
    print(' [8]  For Need Any Help Type 7 And Massage Me On WhatsApp ')
    main_input()
...
def numcloning():
    ...
    print (logo)
    print 
    print(' Pakistan Random Number Cloning ')
    print 
    print(' [*] Enter First 4 Latter Of Any Network : ')
...
def fb_menu():
    ...
    print (logo)
    print ''
    print(' [1] Public Cloning  [Pro]'
    print(' [1;92m[2] Public Cloning  [Fast]'
    print(' 1;91m[0] Back ')
    cz = raw_input('[!] Select : ')
    if cz == '1':
        print 
        print(' Public Cloning Pro ')
        print 
        print(' cloning with pass or name + pass ')
        print 
        print(' [1] Cloning with password ')
        print(' [2] Cloning with name + pass ')
        print(' [0] Back ')
        print ''
        c = raw_input('[!] Select : ')
        ...
        print 
        print(' Public Cloning Fast ')
        print 
        print(' cloning with pass or name + pass ')
        print 
        print(' [1] Cloning With Choice Password ')
        print(' [1;92m[2] Cloning With Name + Pass ')
        print(' [1;92m[3] Cloning With Auto Pass ')
        print(' [0] Back ')
        print 
        vv = raw_input('[!] Select : ')
        if vv == '1':
