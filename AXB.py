...
def banner():
	clear()
	print("""%s  
 .d8b.  d88888D  .d8b.  d8b   db [ AZAN]
d8' `8b YP  d8' d8' `8b 888o  88 
88ooo88    d8'  88ooo88 88V8o 88 [FACEBOOK:AZAN]
88~~~88   d8'   88~~~88 88 V8o88 
88   88  d8' db 88   88 88  V888 [ WP : 03165456679]
...
def login_lagi334():
	...
	warna = random.choice([
 P, M, H, K, B, U, O, N])
	yu = ' Ketik [green]Get[/green] HOW TO GET CooKies'
	yi = nel(yu,style='')
	sol().print(yi)
	cookie=input(f'  [{h}â€¢{x}] Input Cookie :{warna} ')
	...
	try:
		...
		print(f'  {x}[{h}â€¢{x}]{h} LOGIN Successed.........Run the order again!!!!{x} ');time.sleep(1)
		exit()
	except Exception as e:
		os.system("rm -f .token.txt")
		os.system("rm -f .cok.txt")
		print(f'  %s[%sx%s]%s LOGIN Faild.....CEK the Result !!%s'%(x,k,x,m,x))
		exit()
