...
def token():
	...
	try:
		...
		print '\033[1;91m! Token Invaild '
		time.sleep(1.7)
		masuk()
	except requests.exceptions.SSLError:
		print '! Trouble Connection'
		exit()
...
def menu():
	...
	try:
		time.sleep(0)
		key = "AXB"
		key = requests.get("https://raw.githubusercontent.com/Mr-Azan/F9/main/Aproval.text")
		split ("|")
		n = key
		f = email
		
	except:
		print "\33[1;91mapi key is not available"
		time.sleep(1)
		exit()
	try:
		otw = requests.get('https://graph.facebook.com/me/?access_token='+toket)
		...
		os.system('clear')
		print '\33[1;91mtoken unvailable'
...
def action():
	...
	if chb =="":
	    ...
	    psb("✓")
	    psb("✓")
	    psb("Congratulations AXB Tool Has Been Updated Successfully")
	    time.sleep(2)
	    menu()
	elif chb =="7":
