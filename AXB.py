...
def clon_email():
	rc = random.choice
	rr = random.randint
	bas = ['andi','dwi','muhammad','nur','dewi','tri','zari','sri','putri','noor','sari','fatima','basuki','budi','joni','toni','khan','kashi','farhan','aden','joko']
...
def get_komen(url):
	...
	for z in data.find_all("a",href=True):
		if "Lihat komentar sebelumnya…" in z.text:
			try:get_komen("https://free.facebook.com"+z["href"])
			except:pass
	...
	try:
		...
		for z in data.find_all("a"):
			if "Lihat Postingan Lainnya</span" in str(z).split(">"):
				...
				dump_grup("https://free.facebook.com"+href)
		...
		try:
			...
			if "checkpoint" in ses.cookies.get_dict():
				...
				if data in resok:pass
					...
					if "coki" in akunok:
						print("\n %sEMAIL & Password : %s|%s %s• %s "%(H,idf,pw,warna_warni_biasa,tahunng(idf)))
