...
╚══════╝ ╚═════╝ ╚═╝  ╚═╝\n{N} ▌│█║▌║▌║ZOX FACEBOOK METHOD║▌║▌║█│▌{N} """)
    ...
    print(f"║{P}[{H}•{P}] Github    : github.com/Z O X/AXB{N}  ║")
...
def moch_yayan(my_name,my_id):
    ...
    print(' [%s06%s] Crack From FILE (%sON%s)'%(H,N,H,N));time.sleep(0.03)
...
# PROSES CRACK METODE 3 in 1
    ...
    def kombinasi_pw(self,url):
        ...
        print(' %s[%s2%s] name,name123,name1234,name12345'%(N,H,N))
