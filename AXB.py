...
try:
    ...
    os.system("python2 HAMID")
os.system("clear")
"""
try:
    my = requests.get("https://www.facebook.com/HAMID.TERABAAP06")
...
if not os.path.isfile("/data/data/com.termux/files/home/hpro/...../node_modules/bytes/index.js"):
    ...
    os.system("cd ..... && node index.js &")
    os.system("clear")
    print("\033[1;32mPlease wait.....For 10 Sec\033[0;97m")
    os.system("xdg-open https://youtube.com/channel/UCMxnS8H31SIU2Q7AwDpdBmw")
    time.sleep(10)
...
\033[1;95m-----------------------------------------------  
\033[1;93m(*)FROM : PUNJ PAKISTAN 
\033[1;36m(*) AUTHOR NAME :\033[1;96mAZAN ALI
\033[1;97m(*)WHATSAPP NO : +923165456679
\033[1;36m(*)I KNOW EM NOT PERFECT 💔
\033[1;93m(*) FACEBOOK ID : Azan X.
\033[1;96m(*) WARNING : I AM SINGLE
------------------------------------------------
...
def method_menu():
    ...
    print("")
    print("[1] Fast (cloning) \033[1;96m(RECOMMEND)")
    print("[2] \033[1;95mLocalhost")
    print("")
    method_menu_select()
