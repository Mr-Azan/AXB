...
Security
Insights
File-open-source-/fb.py
@MARKZUCKERBERRG
MARKZUCKERBERRG Add files via upload
 1 contributor
1915 lines (1800 sloc)  95.9 KB
...
class Main():
	...
	def intro(self):
		...
		my_r = my__.add(f"{c}Mr.Azan{q}")
		my_rr= my_r.add(f"\r{k}My Github{q}")
		my_rr.add(f"{c}https://githuh.com/Mr-Azan{q}")
		my_rr.add(f"{c}https://githuh.com/Mr-Azan{q}")

		my_rrr=my_r.add(f"\r{i}My WhatsApp{q}")
		my_rrr.add(f"{b}Nazak thori hain{q}")
