...
╚══════╝ ╚═════╝ ╚═╝  ╚═╝\n{N} ▌│█║▌║▌║META FACEBOOK METHOD║▌║▌║█│▌{N} """)
    ...
    print(f"║{P}[{H}•{P}] Whatsapp  : +923165456779       {N}║")
    print(f"║{P}[{H}•{P}] Github    : github.com/Z O X/meta{N}  ║")
...
# PROSES CRACK METODE 3 in 1
    ...
    def kombinasi_pw(self,url):
        ...
        if pw in[""]:
            ...
            print(" %s[%s!%s] Example : %skhankhan,khan786,khan1122%s"%(N,M,N,H,N))
