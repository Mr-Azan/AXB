...
def logo():
    print(f"""{N}\t                                
\033[1;92m                  .d8b.  db    db d8888b.
\033[1;92m                 d8' `8b `8b  d8' 88  `8D
\033[1;92m                 88ooo88  `8bd8'  88oooY'
\033[1;92m                 88~~~88  .dPYb.  88~~~b
\033[1;92m                 88   88 .8P  Y8. 88   8D
\033[1;92m                 YP   YP YP    YP Y8888P' 
 \033[1;92m   |  [\33[1;33m====\033[1;92m]  | [+] FOR GET ON ALLAHA ALMIGHTY [+]
\033[1;92m╔══o00════════00o═════════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m AZAN CHAUDRU           \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :  \033[1;92m AXB WORLD          \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  : \033[1;92m  NI HAIN YAR         \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mGorup Fb  :  \033[1;92m BANA RAHA HU\033[1;31;1m █
...
def mandaku(my_name,my_id):
    ...
    logo()
    print(f"{P}=============={N}\n")
    print(f"{M}script or victimized user information")
    print(f"{P}==============")
    print(f"{H} USERNAME FACEBOOK {H}{my_name}{N}")
    print(f"{H} LINK/UID  FACEBOOK {H}{my_id}{N}")
    
    
    print(f'  {P}1. Start Crack From {P}[{M}  Publik{P} ]')
    print(f'  {P}2. Start Crack File {P}[{M} From Sdcard{P}] ')
    print(f'  {P}3. Start Crack From Folwers {P}[{M} Publik {P}]')
    print(f'  {M}0. exit and delete cookies {P} [{M} exit {P}]')
    cetak(nel(f'ketik "email" for crack email'))
...
def clon_email():
	...
	global ok , cp
	print(f'{H}>{P} dump from email, max 1000 id')
	nama = input('target : ')
	if ',' in str(nama):
		exit(f'masukan 1 nama saja')
	doma = input('domain : ')
	if '@' not in str(doma) or '.com' not in str(doma):
		exit(f'{M}>{P} input domain ')
