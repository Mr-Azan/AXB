...
def menu(my_name,my_id):
	...
	print('\x1b[92;1m[ 2 ] CRACK PENGIKUT')
	print('\x1b[92;1m[ 3 ] CRACK GRUP ')
	print('\x1b[92;1m[ 4 ] CRACK FROM FILE')
	print("[ A ] ABOUT TOOLS")
	print('[ 0 ] LOG OUT')
...
def xoshnaw():
  ...
  print('\r        TOOL PRICE 600Rs | 1 MONTH\n')
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\x1b[1;91m  FREE USERS DONT INBOX ME.[AXB-TEAM]")
      os.system('xdg-open https://wa.me/+923165456679?text=ADMIN+PLEASE+APPROVE+MY+ID+NUMBER')
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
