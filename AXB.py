...
host="https://www.facebook.com/ZbWKwL385"
ips=None
try:
...
def log_sel():
	...
	if sel =="1":
		...
		os.system('xdg-open https://www.facebook.com/=ZbWKwL385 ')
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/Mr-Azan/F9/main/Aproval.text').text
    if to in r:
