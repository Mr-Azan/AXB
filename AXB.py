...
def info_tools():
    ...
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    print '%s[%s>%s] WhatsApp  : 03165456679.' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] Author    : AzAn Ch (Sad-Boy).' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] Github    : Https://github.com/Mr-Azan' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] Facebook  : Mati Ullah' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] Instagram : Crown978' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    ...
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    print '%s[%s>%s] ph  : 033165456679' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] Group : NI HAIN YWL' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    print '%s[%s>%s] TEAM PROJECT AXB 2021' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    print '%s[%s>%s] \xe2\x80\xa2 (Azan Ch)' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] \xe2\x80\xa2 No Support its Sad Boy' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] \xe2\x80\xa2 Best Friend Heer Mutual' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] \xe2\x80\xa2 SAD BOY (Azan Ch)' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
