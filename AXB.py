...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mAZAN_ALI_CHAUDRY')
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					cetak(nel(statuscp1, title='AXB CP'))
				...
				if 'no' in taplikasi:
					...
					cetak(nel(statusok1, title='AXB OK'))
					ok+=1
					break
					...
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='[bold green]AXB OK[/bold green]'))
					ok+=1
					break
