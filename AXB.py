...
-----------------------------------------------
  ➤ Author    : HANIYA BLOACH
  ➤ Github    : https://github.com/Haniyabloach786
  ➤ Facebook  : https://www.facebook.com/Shahzadi.Pari786
...
def main_apv():
    ...
    r1 = requests.get('https://raw.githubusercontent.com/HaniyaBloach/Haniyabloach786/main/server.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
