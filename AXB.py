...
██      ██ ██      ██ ███████                               
  ...
  \033[1;32m|     \033[1;33m[✓] CREATED BY\33[0;m   :  \033[1;33mMD Muhammad moshin  \033[1;92m|
  \033[1;32m|     \033[1;32m[✓] FACEBOK      : \033[1;34m Muhammad moshin             \033[1;92m|
  \033[1;32m|     \033[1;35m[✓] GITHUB       :  \033[1;35irtazaha            \033[1;92m|
...
def main():
    ...
    banner()
    print(f' ')
    print(f'{M}╔══[ [•] TOOL NAME : {H}MOSHIN-007')
    print(f'{M}║══[ [•] YOR IP    : ')
    print(f'{M}║══[ [•] VERSION   : {H}1.0.9')
    print(f'{M}╚══[ [•] TOOL NAME : {H}BLACKX RANDOM\n')
    
    print(f"{M}╔══[{H}[{M}1{H}] \033[1;92mRANDOM PAK 06 DIGIT{RED} (BEST) ")
    print(f"║══[{H}[{M}2{H}] \033[1;92mRANDOM PAK 07 DIGIT ")
    print(f"║══[{H}[{M}3{H}] \033[1;92mRANDOM PAK 08 DIGIT {RED}BEST")
    print(f"║══[{H}[{M}4{H}] \033[1;92mRANDOM PAK 09 DIGIT ")
    print(f"║══[{H}[{M}5{H}] \033[1;92mRANDOM PAK 10 DIGIT ")
    print(f"║══[{H}[{M}6{H}] \033[1;92mRANDOM PAK 11 DIGIT )")
    print(f"║══[{H}[{M}7{H}] \033[1;92mRANDOM PAK 12 DIGIT ")
    print(f"║══[{H}[{M}9{H}] \033[1;92mRANDOM PAK 14 DIGIT ")
...
def sh11():
    ...
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m PAK CODE: {P}[{H}016{P}][{B}017{P}][{K}019{P}][{K}018{P}][{P}013{P}][{K}014{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print("")
...
def sh8():
    ...
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;94m pAK  CODE: {P}[{H}316{P}][{B}344{P}][{K}019{P}][{K}018{P}][{B}013{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    code = input(f'{M}    INPUT CODE {P}:{H} ')
    os.system("clear")
    banner()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mirtazaha","\x1b[1;92mMMS","\x1b[1;93mMMS","\x1b[1;94mMMS","\x1b[1;95mMMS","\x1b[1;96mMMS","\x1b[1;97mMMS","\x1b[1;91mIRTAZA","\x1b[1;92mIRTAZA","\x1b[1;93mIRTAZA","\x1b[1;94mIRTAZA","\x1b[1;95mIRTAZA","\x1b[1;96mIRTAZA"])
