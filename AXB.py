...
logo= f'''
 .S_SSSs     sdSSSSSSSbs   .S_SSSs     .S_sSSs    
.SS~SSSSS    YSSSSSSSS%S  .SS~SSSSS   .SS~YS%%b   
S%S   SSSS          S%S   S%S   SSSS  S%S   `S%b  
S%S    S%S         S&S    S%S    S%S  S%S    S%S  
S%S SSSS%S        S&S     S%S SSSS%S  S%S    S&S  
S&S  SSS%S        S&S     S&S  SSS%S  S&S    S&S  
S&S    S&S       S&S      S&S    S&S  S&S    S&S  
S&S    S&S      S*S       S&S    S&S  S&S    S&S  
S*S    S&S     S*S        S*S    S&S  S*S    S*S  
S*S    S*S   .s*S         S*S    S*S  S*S    S*S  
S*S    S*S   sY*SSSSSSSP  S*S    S*S  S*S    S*S  
SSS    S*S  sY*SSSSSSSSP  SSS    S*S  S*S    SSS  
       SP                        SP   SP          
       Y                         Y    Y                                                           
{50*"-"}
...
def main():
        ...
        if menu_opt =='1':
                ...
                xchker()
                os.system('xdg-open https://github.com/Mr-Azan/AXB')
                main()
        elif menu_opt =='4':
